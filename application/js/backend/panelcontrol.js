...
function usersaccount(){
	...
	$.get(url).done(function(data){
		...
		l ="<table><div id='title_sec' >"+
				"<tr>"+					
					"<td><label class='title_lab' >Identificador</label></td>"+
					"<td><label class='title_lab'>Nombre</label></td>"+
					"<td><label class='title_lab'>Correo electrónico </label></td>"+
					"<td><label class='title_lab'>Fecha de Registro</label></td>"+
					"<td><label class='title_lab'>Perfil</label></td>"+										
					"<td><label class='title_lab'>Descripción del perfil</label></td>"+
				"</tr></div>";
