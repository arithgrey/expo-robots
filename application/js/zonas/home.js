...
function loadzonas(){
    ...
    $.get(url).done(function(data){
        ...
        e="<table class='row' ><tr id='title_table' class='title_table' ><td><span id='zonaname_label' data-tooltip  class='has-tip' title='Identificador de la zona qr'>Identificador</span>";
        ...
        $('#dlg_mensajes_zona').foundation('reveal', 'open');   
            ...
            .done(function(data){
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    l+= "<tr><td>"+descripcion+"</td> <td>"+status+"</td> <td>"+urlformada+"</td> </tr>";
