...
function loadcamp(){
	...
	$.get(url).done(function(data){
		...
		listado="<table><thead><tr><th><h5>ID</h5></th><th><h5>Campaña</h5></th><th><h5>Descripción</h5></th>	<th><h5>Fecha de registro</h5></th>	<th><h5>Evento</h5></th><th><h5>Configuración</h5></th> </tr> </thead> <tbody>";
							...
							for (var a = 0; a < data.length; a++) {									
								...
								listado +="<tr><td>"+idcampaña+"</td> <td><a href='"+direct+"'>"+nombre+"</a></td>"+
										  ...
										  "<td><a><div class='editcamp' id="+idcampaña+"> Editar ✎  </div></a></td></tr>";								
							}					
							listado+=" </tbody></table>";		
